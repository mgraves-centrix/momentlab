...
| **02:30 – 02:45** | `.../results` | *"Once Cut B screening completes, statistical evaluation confirms hypothesis supported with +18.2% engagement lift. Powered by Gemini on Vertex AI and ClickHouse."* | Statistical outcome report & GCP Cloud Run hosted URL. |
