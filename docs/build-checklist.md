...
- [ ] P3 self-review gate is clean (zero open verified defects)
- [ ] Verified work committed (one logical change per commit, no co-author lines) and pushed to a working branch
...
- [ ] `BUILD_TASKS.md` + `docs/build-checklist.md` are current and have pasted verification evidence
