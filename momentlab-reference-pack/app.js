const screens = [
  ...
  {id:'02',category:'desktop',title:'Screening Consent',src:'desktop/02-screening-consent.png',route:'/screenings/new',description:'Explicit research consent, privacy constraints, and screening entry.'},
  {id:'03',category:'desktop',title:'Audience Player',src:'desktop/03-audience-player.png',route:'/experiments/23a/finding',description:'Consented audience playback and structured response capture.'},
  {id:'04',category:'desktop',title:'Response Timeline',src:'desktop/04-response-timeline.png',route:'/experiments/23a/finding',description:'Primary analysis workspace with synchronized player, response cliff, and approval rail.'},
  {id:'05',category:'desktop',title:'Moment Evidence',src:'desktop/05-moment-evidence.png',route:'/experiments/23a/evidence',description:'Evidence records, cohort comparison, uncertainty, and ClickHouse MCP trace.'},
  {id:'06',category:'desktop',title:'Edit Hypothesis',src:'desktop/06-edit-hypothesis.png',route:'/experiments/23a/hypothesis',description:'Agent proposal with observation, rationale, forecast, confounders, and human review.'},
  {id:'07',category:'desktop',title:'Create A/B Test',src:'desktop/07-create-ab-test.png',route:'/experiments/23a/test',description:'Control/variant setup, sample design, guardrails, and approval-gated launch.'},
  {id:'08',category:'desktop',title:'Experiment Results',src:'desktop/08-experiment-results.png',route:'/experiments/23a/results',description:'Clearly simulated results, confidence intervals, cohorts, and query evidence.'},
  ...
  {id:'09',category:'mobile',title:'Mobile Finding',src:'mobile/09-mobile-finding.png',route:'/finding · 390px',description:'Touch-first finding route with video, live chart, response cliff, and evidence CTA.'},
  {id:'10',category:'mobile',title:'Mobile Evidence',src:'mobile/10-mobile-evidence.png',route:'/evidence · 390px',description:'Mobile filmstrip, evidence semantics, cohorts, MCP activity, and hypothesis preview.'},
  {id:'11',category:'mobile',title:'Mobile A/B Test',src:'mobile/11-mobile-test.png',route:'/test · 390px',description:'Stacked cut comparison, forecast, explicit approval, and locked launch state.'},
